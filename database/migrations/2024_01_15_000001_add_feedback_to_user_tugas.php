...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        // Tambah kolom feedback ke tabel kelompok_nilai (dengan pengecekan)
        Schema::table('kelompok_nilai', function (Blueprint $table) {
            if (!Schema::hasColumn('kelompok_nilai', 'komentar')) {
                $table->text('komentar')->nullable()->after('nilai');
            }
            if (!Schema::hasColumn('kelompok_nilai', 'dinilai_oleh')) {
                $table->unsignedBigInteger('dinilai_oleh')->nullable()->after('komentar');
            }
            if (!Schema::hasColumn('kelompok_nilai', 'dinilai_pada')) {
                $table->timestamp('dinilai_pada')->nullable()->after('dinilai_oleh');
            }
        });
