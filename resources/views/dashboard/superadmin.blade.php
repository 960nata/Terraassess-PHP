    ...
    <main class="main-content">
        ...
        <div class="dashboard-grid font-poppins">
            ...
            <x-modern-card class="hover:scale-[1.02] transition-transform">
                <a href="{{ route('superadmin.push-notification') }}" class="flex flex-col h-full">
            ...
            <!-- Row 2 -->
            <x-modern-card class="hover:scale-[1.02] transition-transform">
                <a href="{{ route('superadmin.tugas.index') }}" class="flex flex-col h-full">
            ...
            <x-modern-card class="hover:scale-[1.02] transition-transform">
                <a href="{{ route('superadmin.exam-management') }}" class="flex flex-col h-full">
            ...
            <x-modern-card class="hover:scale-[1.02] transition-transform">
                <a href="{{ route('superadmin.user-management') }}" class="flex flex-col h-full">
                    ...
                    <p class="card-description text-gray-400 text-sm">Kelola semua pengguna sistem (Admin, Guru, Siswa)</p>
                </a>
            </x-modern-card>

            <x-modern-card class="hover:scale-[1.02] transition-transform">
                <a href="{{ route('superadmin.class-management') }}" class="flex flex-col h-full">
            ...
            <!-- Row 4 -->
            <x-modern-card class="hover:scale-[1.02] transition-transform">
                <a href="{{ route('superadmin.subject-management') }}" class="flex flex-col h-full">
                    <div class="card-icon purple mb-4">
                        <i class="fas fa-database"></i>
                    </div>
            ...
            <x-modern-card class="hover:scale-[1.02] transition-transform">
                <a href="{{ route('superadmin.material-management') }}" class="flex flex-col h-full">
                    <div class="card-icon green mb-4">
                        <i class="fas fa-file-alt"></i>
                    </div>
            ...
            <x-modern-card class="hover:scale-[1.02] transition-transform">
                <a href="{{ route('superadmin.push-notification') }}" class="flex flex-col h-full">
                    ...
                    <h3 class="card-title text-xl font-bold text-white mb-2">Notifikasi</h3>
                    <p class="card-description text-gray-400 text-sm">Kelola notifikasi sistem</p>
                </a>
            </x-modern-card>
        </div>
