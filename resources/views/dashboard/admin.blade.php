...
<style>
    ...
    <main class="main-content">
        ...
        <div class="dashboard-grid">
            ...
            <a href="{{ route('admin.exam-management') }}" class="card">
            ...
            <a href="{{ route('superadmin.user-management') }}" class="card">
                ...
                <p class="card-description">Kelola semua pengguna sistem (Guru, Siswa)</p>
            </a>

            <a href="{{ route('admin.class-management') }}" class="card">
                <div class="card-icon green">
            ...
            <!-- Row 4 -->
            <a href="{{ route('admin.subject-management') }}" class="card">
                <div class="card-icon purple">
