...
<div class="page-header">
        ...
        <div class="task-filters">
            <form action="{{ route('teacher.tasks') }}" method="GET" class="filter-form">
...
function editTask(taskId) {
    window.location.href = "{{ url('teacher/tugas') }}/" + taskId + "/edit";
}

function viewSubmissions(taskId) {
    window.location.href = "{{ url('teacher/tugas') }}/" + taskId;
}
...
function deleteTask(taskId) {
    if (confirm('Apakah Anda yakin ingin menghapus tugas ini?')) {
        ...
        form.method = 'POST';
        form.action = "{{ url('teacher/tugas') }}/" + taskId;
