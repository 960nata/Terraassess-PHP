...
@section('container')
                    ...
                    <div class="rounded-2 mb-4 col-12">
                        <div class="rounded-2 mb-4 col-12">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="jawaban" id="pilihan-1" value="1">
                                <label class="form-check-label" for="pilihan-1">
                                    1. <span id="label-pilihan-1"></span>
                                </label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="jawaban" id="pilihan-2" value="2">
                                <label class="form-check-label" for="pilihan-2">
                                    2. <span id="label-pilihan-2"></span>
                                </label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="jawaban" id="pilihan-3" value="3">
                                <label class="form-check-label" for="pilihan-3">
                                    3. <span id="label-pilihan-3"></span>
                                </label>
                            </div>
                            <div class="form-check" id="soal-4">
                                <input class="form-check-input" type="radio" name="jawaban" id="pilihan-4" value="4">
                                <label class="form-check-label" for="pilihan-4">
                                    4. <span id="label-pilihan-4"></span>
                                </label>
                            </div>
                            <div class="form-check" id="soal-5">
                                <input class="form-check-input" type="radio" name="jawaban" id="pilihan-5" value="5">
                                <label class="form-check-label" for="pilihan-5">
                                    5. <span id="label-pilihan-5"></span>
                                </label>
                            </div>
                        </div>
                    </div>
    ...
    <script type="application/json" id="soal-data">{{ json_encode($ujian->soalUjianMultiple) }}</script>
    <script type="application/json" id="countdown-data">{{ $diffInSeconds }}</script>
    ...
    <script>
        ...
        startCountdown(parseInt(document.getElementById('countdown-data').textContent));

        var soalUjianMultiple = JSON.parse(document.getElementById('soal-data').textContent);
        ...
        `;
                ...
                document.getElementById('label-pilihan-1').textContent = selectedSoal.a;
                document.getElementById('label-pilihan-2').textContent = selectedSoal.b;
                document.getElementById('label-pilihan-3').textContent = selectedSoal.c;
                if (selectedSoal.d == null) {
                    // console.log('d = null');
                    // document.getElementById('label-pilihan-4').textContent = selectedSoal.d;
                    // document.getElementById('label-pilihan-4').classList.add('d-none');
                    document.getElementById('soal-4').classList.add('d-none');
                } else {
                    document.getElementById('label-pilihan-4').textContent = selectedSoal.d;
                    document.getElementById('soal-4').classList.remove('d-none');
                }
                if (selectedSoal.e == null) {
                    // console.log('d = null');
                    // document.getElementById('label-pilihan-4').textContent = selectedSoal.d;
                    // document.getElementById('label-pilihan-4').classList.add('d-none');
                    document.getElementById('soal-5').classList.add('d-none');
                } else {
                    document.getElementById('label-pilihan-5').textContent = selectedSoal.e;
                    document.getElementById('soal-5').classList.remove('d-none');
                }
