...
<div class="page-header">
        ...
        <!-- Exam Filters - Simplified -->
        <div class="exam-filters">
            <form action="{{ route('superadmin.exam-management') }}" method="GET" class="filter-form">
        ...
        <div class="exams-table">
            ...
            <div class="table-responsive desktop-table">
                <table class="table">
                    ...
                    <tbody>
                        <tr>
                            <td>
                                <div class="exam-title">Ujian Tengah Semester</div>
                                <div class="exam-description">Ujian tengah semester untuk kelas X IPA 1</div>
                            </td>
                            <td>X IPA 1</td>
                            <td>Matematika</td>
                            <td><span class="type-badge">Pilihan Ganda</span></td>
                            ...
                            <td>
                                <div class="exam-actions">
                                    ...
                                    <button class="btn-success" onclick="viewExam(1)">
                                        <i class="fas fa-eye"></i> Lihat
                                    </button>
                                    <button class="btn-warning" onclick="publishExam(1)">
                        ...
                        <tr>
                            <td>
                                <div class="exam-title">Ujian Akhir Semester</div>
                                <div class="exam-description">Ujian akhir semester untuk kelas XI IPA 1</div>
                            </td>
                            <td>XI IPA 1</td>
                            <td>Fisika</td>
                            <td><span class="type-badge">Campuran</span></td>
                            <td><span class="status-badge status-draft">Draft</span></td>
                            <td>20 Jan 2024 10:00</td>
                            <td>
                                <div class="exam-actions">
                                    <button class="btn-secondary" onclick="editExam(2)">
                                        <i class="fas fa-edit"></i> Edit
                                    </button>
                                    <button class="btn-success" onclick="viewExam(2)">
                                        <i class="fas fa-eye"></i> Lihat
                                    </button>
                                    <button class="btn-warning" onclick="publishExam(2)">
                                        <i class="fas fa-paper-plane"></i> Publikasi
                                    </button>
            ...
            <div class="mobile-cards">
                <div class="exam-card">
                    <div class="exam-card-header">
                        <h3 class="exam-card-title">Ujian Tengah Semester</h3>
                    ...
                    <p class="exam-card-description">Ujian tengah semester untuk kelas X IPA 1</p>
                ...
                <div class="exam-card">
                    <div class="exam-card-header">
                        <h3 class="exam-card-title">Ujian Akhir Semester</h3>
                        <div class="exam-card-badges">
                            <span class="type-badge">Campuran</span>
                            <span class="status-badge status-draft">Draft</span>
                        </div>
                    </div>
                    
                    <p class="exam-card-description">Ujian akhir semester untuk kelas XI IPA 1</p>
...
function createMultipleChoiceExam() {
    ...
    window.location.href = "{{ route('superadmin.exam-management.create-multiple-choice') }}";
}

function createEssayExam() {
    // Redirect ke halaman pembuatan soal essay
    window.location.href = "{{ route('superadmin.exam-management.create-essay') }}";
}
