    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="bg-gray-800 rounded-xl shadow-2xl overflow-hidden border border-gray-700">
            ...
            <div class="p-6 bg-gray-800">
                <form id="multipleChoiceForm" method="POST" action="{{ route('superadmin.tasks.store') }}" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="flex justify-end space-x-4 mt-8">
                        <a href="{{ route('superadmin.task-management') }}" class="px-6 py-3 bg-gray-600 text-white rounded-lg hover:bg-gray-700 transition duration-200">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (form) {
        form.addEventListener('submit', function(e) {
            ...
            console.log('Form submit (Superadmin) - Data being submitted:', new FormData(form));
        });
    }
});
