...
<div class="page-header">
        ...
        <div class="exam-filters">
            <form action="{{ route('admin.exam-management') }}" method="GET" class="filter-form">
        ...
        <div class="exams-table">
            ...
            <div class="table-responsive desktop-table">
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>
                                <div class="exam-title">{{ $exam->judul_ujian }}</div>
                                <div class="exam-description">{{ $exam->deskripsi ?? 'Tidak ada deskripsi' }}</div>
                            </td>
                            ...
                            <td>
                                <span class="status-badge {{ $exam->is_active ? 'status-active' : 'status-draft' }}">
            ...
            <div class="mobile-cards">
                ...
                <div class="exam-card">
                    <div class="exam-card-header">
                        <h3 class="exam-card-title">{{ $exam->judul_ujian }}</h3>
                    ...
                    <p class="exam-card-description">{{ $exam->deskripsi ?? 'Tidak ada deskripsi' }}</p>
                    
                    <div class="exam-card-info">
                        <div class="info-item">
                            <i class="fas fa-graduation-cap"></i>
                            <span>{{ $exam->KelasMapel->Kelas->nama_kelas ?? 'N/A' }}</span>
                        </div>
                        <div class="info-item">
                            <i class="fas fa-book"></i>
                            <span>{{ $exam->KelasMapel->Mapel->nama_mapel ?? 'N/A' }}</span>
                        </div>
                        <div class="info-item">
...
function deleteExam(examId) {
    if (confirm('Apakah Anda yakin ingin menghapus ujian ini?')) {
        ...
        form.method = 'POST';
        form.action = "{{ url('admin/exam-management') }}/" + examId;
