...
<div class="container mx-auto px-4 py-8">
    <div class="mb-8">
        <h1 class="text-3xl font-bold text-gray-900 dark:text-white mb-2">Pengaturan Admin</h1>
            ...
            <div class="space-y-6">
                <div>
                    <label class="flex items-center">
                        ...
                        <span class="ml-2 text-sm text-gray-700 dark:text-gray-300">Aktifkan 2FA untuk Admin</span>
                    </label>
                </div>
