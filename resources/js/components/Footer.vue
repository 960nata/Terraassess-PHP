      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
        ...
        <div class="lg:col-span-2">
          <div class="flex items-center space-x-2 mb-6">
            ...
            <span class="text-2xl font-bold text-white">Elass</span>
          </div>
          <p class="text-gray-300 text-lg leading-relaxed mb-6 max-w-md">
            Platform monitoring IoT yang dirancang khusus untuk mendukung penelitian siswa 
            dalam bidang pertanian dan lingkungan dengan teknologi terdepan.
          </p>
        ...
        <!-- Support -->
        <div>
          <h3 class="text-xl font-bold text-white mb-6">Dukungan</h3>
          <ul class="space-y-3">
            ...
            <li><a href="#" class="text-gray-300 hover:text-white transition-colors">Komunitas</a></li>
          </ul>
        </div>
      </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div>
            ...
            <div class="space-y-2">
              <div class="flex items-center space-x-3">
                ...
                <span class="text-gray-300">info@elass.com</span>
              </div>
              <div class="flex items-center space-x-3">
                <svg class="w-5 h-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div>
            ...
            <p class="text-gray-300 mb-4">
              Dapatkan update terbaru tentang fitur dan perkembangan Elass.
            </p>
            <div class="flex">
              <input
                type="email"
              ...
              />
              <button class="px-6 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-r-lg transition-colors">
                Subscribe
              </button>
            </div>
          </div>
      ...
      <div class="border-t border-gray-700 pt-8 mt-8">
        <div class="flex flex-col md:flex-row justify-between items-center">
          <p class="text-gray-400 text-sm">
            © 2024 Elass. All rights reserved.
          </p>
